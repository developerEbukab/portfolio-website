...
export const AllProjects = [
  {
    ...
    description: "To challenge my full stack coding skills , i decided to make a clone of YouTube. This is a very interesting project as it really tested my design, implementation and data management abilities",
    placeholderImage : 'youtube-1.png',
    images: ['youtube-1.png',  'youtube-2.png', 'youtube-3.png',  'youtube-4.png', 'youtube-5.png', 'youtube-6.png'],
    stack: [ALLSKILLS["HTML5"], ALLSKILLS["Sass"], ALLSKILLS["Javascript"], ALLSKILLS["React"], ALLSKILLS["Redux"], ALLSKILLS["Firebase"], ALLSKILLS["Git"]],
    functionalities: [
  ...
  },
  {
    ...
    description: "A Complete rich featured E-commerce online store. Users can sign up/ login, social login, browse different store collections,  add / remove / increment items in cart, make purchases, etc ",
    placeholderImage : 'crown-clothing-4.png',
    images: ['crown-clothing-3.png',  'crown-clothing-4.png', 'crown-clothing-1.png',  'crown-clothing-2.png', 'crown-clothing-5.png',  'crown-clothing-6.png', 'crown-clothing-7.png',  'crown-clothing-8.png'],
    stack: [ALLSKILLS["HTML5"], ALLSKILLS["Sass"], ALLSKILLS["Javascript"], ALLSKILLS["React"], ALLSKILLS["Redux"], ALLSKILLS["Firebase"], ALLSKILLS["Stripe"], ALLSKILLS["Git"], ALLSKILLS["NodeJs"], ALLSKILLS["ExpressJs"]],
    functionalities: [
      <p>I used Html5, Sass, and JSX to implement clean Modern User Interface Design</p>,
      <p>I used ReactJs and Styled-Components to create re-usable components and structure the application</p>,
      <p>I used Redux to implement state management</p>,
      <p>I used Redux Persist to remember items stored in cart</p>,
      <p>I used React Router Dom to implement multiple page routing and navigation</p>,
      <p>I used Firebase and it's API's to implement user authentication, data storage/fetching of store items</p>,
  ...
  },
  {
    ...
    description: "A Fully responsive website built with modern design and styling principle. Made to look good on different screen resolutions including Desktop, Tablet, mobile, etc   ",
    placeholderImage : 'Natour-1.png',
    images: ['Natour-1.png',  'Natour-2.png', 'Natour-3.png',  'Natour-4.png', 'Natour-5.png', 'Natour-7.png',  'Natour-8.png', 'Natour-9.png',  'Natour-10.png'],
    stack: [ALLSKILLS["HTML5"], ALLSKILLS["CSS3"], ALLSKILLS["Sass"], ALLSKILLS["Git"]],
    functionalities: [
      <p>Clean Modern User Interface Design</p>,
      ...
      <p>Implemented latest CSS features like floats , flexbox , CSS Grid, etc</p>,
    ],
  ...
  },
  {
    ...
    functionalities: [
      ...
      <p>Responsive web design for different screen resolutions</p>,
      <p>Cool animations and transitions</p>,
      <p>Nice gallery of images arranged in grid view with CSS Grid properties</p>,
      <p>Implemented latest CSS features like floats , flexbox , CSS Grid, etc</p>,
    ],
